...
public final class GridMetricsTest {
    ...
    public void sixColumnsFillA1080pScreenWithoutHiddenRows() {
        GridMetrics metrics = GridMetrics.calculate(1920, 1080, 6, 6, 100, 2f);
    ...
    public void cardScaleDoesNotMoveFocusTracks() {
        GridMetrics normal = GridMetrics.calculate(1920, 1080, 6, 6, 100, 2f);
        GridMetrics compact = GridMetrics.calculate(1920, 1080, 6, 6, 80, 2f);
    ...
    public void fiveColumnsKeepEqualScreenMargins() {
        GridMetrics metrics = GridMetrics.calculate(1920, 1080, 5, 5, 100, 2f);
    ...
    public void sparseRowsKeepConfiguredCardSizeAndCenterRealItems() {
        GridMetrics full = GridMetrics.calculate(1920, 1080, 6, 6, 100, 2f);
